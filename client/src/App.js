      ...
      <div id="introCarousel" className="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div className="carousel-inner" role="listbox">
          ...
          <div className="item active">
            <div className="carousel-background"><img src="img/intro/1.jpg" alt="" /></div>
            <div className="carousel-container">
              <div className="carousel-content">
                <h2 className="animated fadeInDown">Alstar web studio</h2>
          ...
          {/* <!-- Slide 2 --> */}
          <div className="item">
            <div className="carousel-background"><img src="img/intro/2.jpg" alt="" /></div>
            <div className="carousel-container">
              <div className="carousel-content">
                <h2 className="animated fadeInDown"><span>Creativity and technology</span></h2>
                <p className="animated fadeInUp">Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea ut et est quaerat sequi nihil ut aliquam. Occaecati alias dolorem mollitia ut. Similique ea voluptatem. Esse doloremque accusamus repellendus deleniti vel. Minus et tempore modi architecto.</p>
                <a href="#about" className="btn-get-started animated fadeInUp">Read More</a>
              </div>
            </div>
          ...
          {/* <!-- Slide 3 --> */}
          <div className="item">
            <div className="carousel-background"><img src="img/intro/3.jpg" alt="" /></div>
            <div className="carousel-container">
              <div className="carousel-content">
                <h2 className="animated fadeInDown"><span>Sequi ea ut et est quaerat</span></h2>
                <p className="animated fadeInUp">Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea ut et est quaerat sequi nihil ut aliquam. Occaecati alias dolorem mollitia ut. Similique ea voluptatem. Esse doloremque accusamus repellendus deleniti vel. Minus et tempore modi architecto.</p>
                <a href="#about" className="btn-get-started animated fadeInUp">Read More</a>
              </div>
            </div>
